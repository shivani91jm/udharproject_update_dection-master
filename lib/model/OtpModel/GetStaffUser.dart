...
import 'package:udharproject/model/OtpModel/GetBussinessInformation.dart';
...
class GetStaffUser {
  ...
  String? createdAt;
  String? updatedAt;
  List<GetBussinessInfoMation>? getBusiness;
  ...
  GetStaffUser.fromJson(Map<String, dynamic> json) {
    ...
    if (json['get_business'] != null) {
      getBusiness = <GetBussinessInfoMation>[];
      json['get_business'].forEach((v) {
        getBusiness!.add(new GetBussinessInfoMation.fromJson(v));
      });
    }
  }
